...
client.on('message', msg => { // Leaked by [ @! Abdulrhman#1001, @! KiNg66S.❤#8047 ]
...
client.on("guildMemberAdd", member => { // Leaked by [ @! Abdulrhman#1001, @! KiNg66S.❤#8047 ]
...
client.on("message",function(message) { // Leaked by [ @! Abdulrhman#1001, @! KiNg66S.❤#8047 ]
...
message.channel.send(`let args = message.content.split(" ").slice(${args}).join(" ")`);
    ...
    if(message.content.startsWith(prefix + "server")) { // Leaked by [ @! Abdulrhman#1001, @! KiNg66S.❤#8047 ]
...
client.on('guildCreate', guild => { // Leaked by [ @! Abdulrhman#1001, @! KiNg66S.❤#8047 ]
var message = "zg";
         const embed = new Discord.RichEmbed()
     .setColor("GOLD")
...
client.on('guildDelete', guild => { // Leaked by [ @! Abdulrhman#1001, @! KiNg66S.❤#8047 ]
var message = "zg";
         const embed = new Discord.RichEmbed()
     .setColor("GOLD")
     .setTitle('S Bot Link Click Here .!')
...
client.on('message', async message => { // Leaked by [ @! Abdulrhman#1001, @! KiNg66S.❤#8047 ]
...
client.on('message',   eyad =>{ // Leaked by [ @! Abdulrhman#1001, @! KiNg66S.❤#8047 ]
